...
dx download "$PROJECT:/resources/GHS100sample.CombineGVCFs.gvcf.gz" -o combined.gvcf.gz
dx download "$PROJECT:/resources/GHS100sample.CombineGVCFs.gvcf.gz.tbi" -o combined.gvcf.gz.tbi
dx download "$PROJECT:/resources/idsnp_5b_hg19_nochr.bed" -o targets.bed
