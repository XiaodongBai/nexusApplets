...
# ----------
#
configureBclToFastq.pl --input-dir "$input_dir" --output-dir output/Unaligned --sample-sheet casava_sample_sheet.csv --fastq-cluster-count 0 --mismatches 1 $advanced_opts
